//! The CIFAR-10 training chart, drawn with `malevich`: the raw
//! minibatch loss, a rolling mean, and the uniform-model cost as the
//! line every run starts from and should fall well below.

...
use poorgrad::{BatchNorm, Network, Shape, Tensor, Tensorial, Value, cross_entropy, init};
...
fn main() {
    ...
    let training_plan = network.compile_training(loss_symbol, [mean_symbol, variance_symbol]);
